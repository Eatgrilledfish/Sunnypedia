def calculate_clothing_coverage(gender, head, top, bottom, shoes):
    ...
    # 调试输出
    # print("for had value:",gender_coverage.get('head', {}).get(head, 0))
    # print("for top value:",gender_coverage.get('top', {}).get(top, 0))
    # print("for bottom value:",gender_coverage.get('bottom', {}).get(bottom, 0))
    # print("for shoes value:",gender_coverage.get('shoes', {}).get(shoes, 0))
...
def calculate_sunscreen_amount(gender, height, weight, head, top, bottom, shoes):
    ...
    sunscreen_teaspoons = round(sunscreen_amount_ml / 5)  # 假设1茶匙=5ml

    # 调试输出
    # print("this is the cloth",gender, head,top,bottom,shoes)
